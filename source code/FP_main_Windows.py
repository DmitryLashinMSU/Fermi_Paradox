'''
Графический интерфейс для запуска симуляции в Windows.
Запускать можно и без него, так как сама симуляция, обработка
ее результатов и построение графиков реализованы в FP_logic.py.

Эту программу я бессовестно навайбкодил, но в силу сказанного выше
на сам процесс симуляции это никак не влияет.
'''
